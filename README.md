...
* [`src/ionsails/`](src/ionsails/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/ionsails/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `ionsails` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/ionsails/config.cljs) defaults to `true` in
...
```clj
(ns ionsails.example
  (:require [ionsails.config :as config])
